...
def predict(image_path: str, device: str, model_name: str):
    ...
    model.load_state_dict(torch.load(os.path.join(config.BASE_PATH, 'data', 'models',
                                                  f'{model_name}', 'model_dict.pt'), map_location=device))
...
if __name__ == '__main__':
    ...
    cv2.putText(orig, f"Label: {best_class}, prob: {best_prob}", (10, 30),
